...
enum M2SMetadataOffsets {
  GLOBAL_WORK_SIZE_X                        = 0,
  GLOBAL_WORK_SIZE_Y                        = 4,
  GLOBAL_WORK_SIZE_Z                        = 8,
  WORK_DIM                                  = 12,
  LOCAL_WORK_SIZE_X                         = 16,
  LOCAL_WORK_SIZE_Y                         = 20,
  LOCAL_WORK_SIZE_Z                         = 24,
  RESERVED_0                                = 28,
  GLOBAL_WORK_SIZE_X_DIV_LOCAL_WORK_SIZE_X  = 32,
  GLOBAL_WORK_SIZE_Y_DIV_LOCAL_WORK_SIZE_Y  = 36,
  GLOBAL_WORK_SIZE_Z_DIV_LOCAL_WORK_SIZE_Z  = 40,
  RESERVED_1                                = 44,
  ...
  RESERVED_7                                = 172,
  GLOBAL_WORK_SIZE_X_DIV_REGION_WORK_SIZE_X = 176,
  GLOBAL_WORK_SIZE_Y_DIV_REGION_WORK_SIZE_Y = 180,
  GLOBAL_WORK_SIZE_Z_DIV_REGION_WORK_SIZE_Z = 184,
  RESERVED_8                                = 188,
  REGION_WORK_SIZE_X_DIV_LOCAL_WORK_SIZE_X  = 192,
  REGION_WORK_SIZE_Y_DIV_LOCAL_WORK_SIZE_Y  = 196,
  REGION_WORK_SIZE_Z_DIV_LOCAL_WORK_SIZE_Z  = 200,
  OFFSET_SW_GWS                             = 204
};
